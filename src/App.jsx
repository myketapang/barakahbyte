...
import {
  ...
  X, Trophy, ChevronLeft, Star, Flame,
    ...
    return (
      <div className="animate-slide-up">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="space-y-3">
            <a
              href={`https://wassap.my/6${(selected.phone || '123456789').replace(/^0/, '')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] p-4 rounded-2xl font-bold text-sm flex items-center justify-center gap-3 btn-press hover:bg-[#25D366]/20 transition-all"
            >
      ...
      <div className="animate-slide-up">
        ...
        <form ref={formRef} onSubmit={handlePostSurplus} className="p-5 space-y-4">
          ...
          {[
            ...
            { name: 'phone', placeholder: 'e.g. 0123456789', label: 'WhatsApp Number', type: 'tel' },
          ].map(f => (
            <div key={f.name}>
